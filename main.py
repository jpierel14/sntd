...
fig=fitCurves.plot_object(savefig=False,showModel=False,combined=False,showFit=True,showMicro=False)
refModel=sntd.fitting.create_composite_model(fitCurves,'F110W','image_1',weight='logz')
fitCurves=sntd.fit_data(myMISN,snType='Ia', models=modname,bands=['F110W'],
                        params=['x0','x1','t0','c'],constants={'z':1.33},
                        refModel=refModel,
                        bounds={'t0':(-15,15),'x1':(-2,2),'c':(0,1)},showPlots=False,method='combined')
#myMISN.combine_curves(time_delays={'image_1':10,'image_2':78},magnifications={'image_1':7,'image_2':3.5})
fig=fitCurves.plot_object(savefig=False,showModel=False,combined=True,showFit=True,showMicro=False)
plt.show()
